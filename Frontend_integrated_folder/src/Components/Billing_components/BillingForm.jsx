...
const BillingForm = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md w-full">
      ...
      <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col">
          <h1 className="text-[1.25rem] font-black text-black w-full">
            Additional <span className="text-blue-400">Info</span>
          </h1>
      ...
      <button
        className="mt-6 w-full bg-blue-500 text-white px-6 py-3 rounded-md text-lg font-semibold hover:bg-blue-400 transition-all"
