...
export default function ProductPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get("http://localhost:8000/products"); // Fetch products from API
  ...
  // Handle product click and store product data in session storage
  ...
  return (
    <div className="w-[88%] mx-auto">
      <div className="w-full text-black pb-12">
        ...
        <div className="flex flex-wrap items-center mb-4 text-sm">
          ...
          <span className="mx-2 text-black">›</span>
          <span className="text-blue-300">shop</span>
        </div>
